...
* Check the [Issues](https://github.com/antus/antus/issues) on Github to ensure one doesn't already exist.
...
## Documentation (antus.org)

The code for the documentation and the website are located in the antus/antus repo on the gh-pages branch. The website is hosted by github pages and generated using jekyll. See the README in the gh-pages branch for more information on how to get your dev enviorment set-up.
